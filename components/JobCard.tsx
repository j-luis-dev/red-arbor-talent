...
export function JobCard({ job, index = 0 }: JobCardProps) {
  ...
  const transition = reduceMotion
    ...
    : { type: 'timing' as const, duration: 300, delay: index * 50 };
  ...
  return (
    ...
    >
      <Card
        style={styles.card}
        onPress={handlePress}
        accessibilityLabel={`${job.title} @ ${job.company_name}`}
        accessibilityHint={t('Job card hint')}
        ...
        <Card.Content style={styles.content}>
          <View style={styles.row}>
            ...
            <IconButton
              ...
              size={24}
              iconColor={
                isFavorite ? theme.colors.error : theme.colors.onSurfaceVariant
              }
...
const styles = StyleSheet.create({
  ...
  company: { opacity: 0.85, marginTop: 2 },
